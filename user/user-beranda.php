<?php include('user-header.php'); ?>
                ...
                <div class="main">
                    ...
                    <?php
                        ...
                        $sqlProses = mysqli_query($koneksi, "SELECT COUNT(*) as statusY FROM tb_pengaduan WHERE id_pengguna = '$userID' AND status = 'Proses'");
                        $sqlSelesai = mysqli_query($koneksi, "SELECT COUNT(*) as statusX FROM tb_pengaduan WHERE id_pengguna = '$userID' AND status = 'Selesai'");
                    ...
                    <div class="notification">
                        <div class="red" style="--a: #f72516; --b: #e01709;">
                            <h5>Laporan Diproses <span><?php echo $result1['statusY']; ?></span></h5>
                        </div>
