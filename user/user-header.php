        ...
        <div class="white-box">
            <div class="box">
                <div class="sidebar">
                    ...
                    <div class="feature">
                        <div class="links"><hr>
                            <a href="user-beranda.php"><i class="material-icons">dashboard</i>Beranda</a>
                            <a href="tulis-laporan.php"><i class="material-icons">report</i>Tulis Laporan</a>
                            <a href="daftar-laporan.php"><i class="material-icons">question_answer</i>Daftar Laporan</a>
                        </div>

                        <div class="logout"><hr>
                            <a href="../proses.php?logout=<?php echo $_SESSION['userID']; ?>" onclick="return confirm('Apakah anda yakin ?')"><i class="material-icons">logout</i>Logout</a>
                        </div>
                    </div>
                </div>
