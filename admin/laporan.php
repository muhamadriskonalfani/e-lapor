<?php include('admin-header.php'); ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="../proses.php?hapus-laporan=<?php echo $dataReport['id_pengaduan'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin?')">hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                    }
                ...
                <script>
                    ...
                    // Active Button
                    document.querySelectorAll('.links a')[5].classList.add('active');
                </script>
